...
import { getMemory } from "@/selectors/kubernetes/1.30/IoK8sApiCoreV1Node";
import { BinarySI } from "@/selectors/kubernetes/1.30/IoK8sApimachineryPkgApiResourceQuantity";
