...
// +kubebuilder:validation:Enum=v5.2.3.0
...
type FusionAccessSpec struct {
	...
	// +operator-sdk:csv:customresourcedefinitions:type=spec,order=2,xDescriptors={"urn:alm:descriptor:com.tectonic.ui:select:v5.2.3.0"}
